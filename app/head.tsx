export default function Head() {
	return (
		<>
			...
			<meta property="og:title" content="Futures Leaders Summit '22"/>
			<meta property="og:description"
			      content="Futures Leaders Summit is an event that annually gathers prosperous changemakers in the field of STEM."/>
			<meta property="og:image" content="https://www.fls.ba/share.png"/>
			<meta property="og:image:secure_url" content="https://www.fls.ba/share.png"/>
			<meta property="og:image:width" content="1200"/>
			<meta property="og:image:height" content="630"/>
			<meta property="og:image:alt" content="Futures Leaders Summit '22"/>
			...
			<meta name="twitter:title" content="Futures Leaders Summit '22"/>
